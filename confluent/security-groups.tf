...
resource "aws_security_group" "proxy" {
  description = "Proxy security group - Managed by Terraform"
  name = "${var.ownershort}-proxy"
...
resource "aws_security_group" "lb" {
  description = "LB security group - Managed by Terraform"
  name = "${var.ownershort}-lb"
